...
public class GameDaoImpl implements GameDao{
    ...
    public Game addGame(Game game) {
        ...
        final String INSERT_GAME = "INSERT INTO"
                + " game(correctSolution)"
                + " VALUES (?)";

        jdbc.update(INSERT_GAME, game.getCorrectSolution());
    ...
    //THIS WAS UPDATE TO UPDATE SOLTUTION TOO
    @Override
    public void updateGame(Game game) {
        ...
        jdbc.update(UPDATE_GAME, game.getGameOver(), game.getCorrectSolution(), game.getGameId());
    }
    ...
    public static final class GameMapper implements RowMapper<Game>{
        ...
        public Game mapRow(ResultSet rs, int i) throws SQLException {
            ...
            game.setCorrectSolution(rs.getString("CorrectSolution"));
            game.setGameOver(rs.getBoolean("gameOver"));
